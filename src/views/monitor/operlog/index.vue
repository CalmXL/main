<template>
  <PageContent class="app-container">
    ...
    >
      ...
      <el-table-column label="日志编号" align="center" prop="operId" fixed="left" />
      <el-table-column
        label="操作人员"
        align="center"
        width="110"
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right">
        <template #default="scope">
          <el-button v-hasPermi="['monitor:operlog:query']" link type="primary" @click="handleView(scope.row, scope.index)">
            详细
          </el-button>
        </template>
      </el-table-column>
