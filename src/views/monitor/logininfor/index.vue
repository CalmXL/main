<template>
  <PageContent class="app-container">
    ...
    >
      ...
      <el-table-column label="访问编号" align="center" prop="infoId" fixed="left" />
      <el-table-column
        label="用户名称"
        align="center"
        prop="userName"
      ...
      <el-table-column label="角色名称" align="center" prop="roleName" width="130" />
      <el-table-column label="部门名称" align="center" prop="deptName" width="130" />
      <el-table-column label="地址" align="center" prop="ipaddr" width="160" :show-overflow-tooltip="true" />
      ...
      <el-table-column label="描述" header-align="center" prop="msg" :show-overflow-tooltip="true" width="200" />
      <el-table-column
        label="访问时间"
        align="center"
        prop="loginTime"
