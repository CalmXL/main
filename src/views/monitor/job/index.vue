<template>
  <PageContent class="app-container">
    ...
    <el-table v-loading="loading" :data="jobList" class="base-table" stripe height="100%" @selection-change="handleSelectionChange">
        ...
        <template #default="scope">
          <el-popover placement="left" :width="340" trigger="hover">
            ...
            <div class="flex justify-center items-center">
              <el-button v-hasPermi="['monitor:job:edit']" link type="primary" @click="handleUpdate(scope.row)">修改</el-button>
              <el-button v-hasPermi="['monitor:job:remove']" link type="primary" @click="handleDelete(scope.row)">删除</el-button>
              <el-button v-hasPermi="['monitor:job:changeStatus']" link type="primary" @click="handleRun(scope.row)">执行一次</el-button>
              <el-button v-hasPermi="['monitor:job:query']" link type="primary" @click="handleView(scope.row)">任务详细</el-button>
              <el-button v-hasPermi="['monitor:job:query']" link type="primary" @click="handleJobLog(scope.row)">调度日志</el-button>
            </div>
          </el-popover>
        </template>
      </el-table-column>
