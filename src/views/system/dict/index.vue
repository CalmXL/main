<template>
  <PageContent>
    ...
    <el-table v-loading="loading" height="100%" class="base-table" stripe :data="typeList" @selection-change="handleSelectionChange">
        ...
        <template #default="scope">
          <el-popover placement="left" :width="'auto'" trigger="hover">
            ...
            <div>
              ...
              <el-button v-hasPermi="['system:dict:remove']" link type="danger" icon="Delete" @click="handleDelete(scope.row)">
                删除
              </el-button>
            </div>
          </el-popover>
