...
// 双时间-添加日期范围
export function addDateRangeTwo(params: any, dateRange1: any[], propName1?: string, dateRange2: any[], propName2?: string) {
  const search = params
  search.params = typeof search.params === 'object' && search.params !== null && !Array.isArray(search.params) ? search.params : {}
  ...
  if (typeof propName1 === 'undefined') {
    ...
    search.params[`begin${propName1}`] = dateRange1[0]
    search.params[`end${propName1}`] = dateRange1[1]
  }
  dateRange2 = Array.isArray(dateRange2) ? dateRange2 : []
  if (typeof propName2 === 'undefined') {
    search.params.beginTime = dateRange2[0]
    search.params.endTime = dateRange2[1]
  } else {
    search.params[`begin${propName2}`] = dateRange2[0]
    search.params[`end${propName2}`] = dateRange2[1]
  }
  return search
}
